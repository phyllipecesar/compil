		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTemplateIdAccess().getAlternatives_0(), "rule__TemplateId__Alternatives_0");
					...
					put(grammarAccess.getAttributeSpecifierAccess().getGroup(), "rule__AttributeSpecifier__Group__0");
					...
					put(grammarAccess.getTemplateIdAccess().getGroup(), "rule__TemplateId__Group__0");
