		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBodyAccess().getDeclarationsAssignment_2_1(), "rule__Body__DeclarationsAssignment_2_1");
					put(grammarAccess.getDeclarationAccess().getDitryDAssignment_1_0(), "rule__Declaration__DitryDAssignment_1_0");
					put(grammarAccess.getDeclarationAccess().getFuncaoAssignment_1_1(), "rule__Declaration__FuncaoAssignment_1_1");
					put(grammarAccess.getDeclarationAccess().getDirtyEAssignment_1_2(), "rule__Declaration__DirtyEAssignment_1_2");
					put(grammarAccess.getDeclarationAccess().getDirtyAAssignment_1_3(), "rule__Declaration__DirtyAAssignment_1_3");
					put(grammarAccess.getDeclarationAccess().getDirtyBAssignment_1_4(), "rule__Declaration__DirtyBAssignment_1_4");
					put(grammarAccess.getDeclarationAccess().getDirtyCAssignment_1_5(), "rule__Declaration__DirtyCAssignment_1_5");
					put(grammarAccess.getDeclarationAccess().getDirtyDAssignment_1_6(), "rule__Declaration__DirtyDAssignment_1_6");
					put(grammarAccess.getDeclarationAccess().getDirtyAssignment_1_7(), "rule__Declaration__DirtyAssignment_1_7");
					put(grammarAccess.getDeclarationAccess().getDirtyAssignment_1_8(), "rule__Declaration__DirtyAssignment_1_8");
