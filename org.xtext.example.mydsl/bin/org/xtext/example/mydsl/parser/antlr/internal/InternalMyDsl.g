...
(
		{ 
	        newCompositeNode(grammarAccess.getDeclarationAccess().getChamadaFunctionChamadaParserRuleCall_1_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getDeclarationAccess().getSemicolonKeyword_1_2_1());
    }
)
    |(
(
		...
		lv_funcao_5_0=ruleFunctionDeclaration		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirtyE_6_0=ruleSimpleOrFunctionDeclaration		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirtyA_7_0=ruleBlockDeclaration		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirtyB_8_0=ruleTemplateDeclaration		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirtyC_9_0=ruleExplicitInstantiation		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirtyD_10_0=ruleExplicitSpecialization		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirty_11_0=ruleLinkageSpecification		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
(
		...
		lv_dirty_12_0=ruleNamespaceDefinition		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDeclarationRule());
	        }
       		set(
...
this_STRING_2=RULE_STRING
    { 
    newLeafNode(this_STRING_2, grammarAccess.getLinkageSpecificationAccess().getSTRINGTerminalRuleCall_2()); 
    }
((
(
		{ 
...
entryRuleHEADER_NAME returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getHEADER_NAMERule()); } 
	 iv_ruleHEADER_NAME=ruleHEADER_NAME 
	 { $current=$iv_ruleHEADER_NAME.current.getText(); }  
	 EOF 
;

// Rule HEADER_NAME
ruleHEADER_NAME returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getHEADER_NAMEAccess().getLessThanSignKeyword_0_0()); 
    }
(    this_ID_1=RULE_ID    {
    ...
    { 
    newLeafNode(this_ID_1, grammarAccess.getHEADER_NAMEAccess().getIDTerminalRuleCall_0_1_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getHEADER_NAMEAccess().getFullStopKeyword_0_1_1()); 
    }
)*
	kw='>' 
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getHEADER_NAMEAccess().getGreaterThanSignKeyword_0_2()); 
    }
)
    ...
    { 
    newLeafNode(this_STRING_4, grammarAccess.getHEADER_NAMEAccess().getSTRINGTerminalRuleCall_1()); 
    }
)
    ;
...
rulepreprocessing_token returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    ...
    { 
        newCompositeNode(grammarAccess.getPreprocessing_tokenAccess().getHEADER_NAMEParserRuleCall()); 
    }
    this_HEADER_NAME_0=ruleHEADER_NAME    {
...
(
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getFunctionChamadaAccess().getRightParenthesisKeyword_4());
    }
)
;
...
((
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getNoPtrStatementAccess().getBreakKeyword_1_0());
    }

    |(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getVariaveisVarDeclParserRuleCall_1_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getMudancasNoPtrMudancaParserRuleCall_1_2_0()); 
	    }
		lv_mudancas_3_0=ruleNoPtrMudanca		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getLixoVNoPtrExpressionParserRuleCall_1_3_0()); 
	    }
		lv_lixoV_4_0=ruleNoPtrExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getSwitchesNoPtrSelectParserRuleCall_1_4_0()); 
	    }
		lv_switches_5_0=ruleNoPtrSelect		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getDirtyBReturnParserRuleCall_1_5_0()); 
	    }
		lv_dirtyB_6_0=ruleReturn		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getDirtUNoPtrForParserRuleCall_1_6_0()); 
	    }
		lv_dirtU_7_0=ruleNoPtrFor		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getDirtyABCNoPtrWhileParserRuleCall_1_7_0()); 
	    }
		lv_dirtyABC_8_0=ruleNoPtrWhile		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getDirtyStatementParserRuleCall_1_8_0()); 
	    }
		lv_dirty_9_0=ruleStatement		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrStatementAccess().getDirtyVFunctionChamadaParserRuleCall_1_9_0()); 
	    }
		lv_dirtyV_10_0=ruleFunctionChamada		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrStatementRule());
	        }
       		add(
...
entryRuleNoPtrFor returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrForRule()); }
	 iv_ruleNoPtrFor=ruleNoPtrFor 
	 { $current=$iv_ruleNoPtrFor.current; } 
	 EOF 
;

// Rule NoPtrFor
ruleNoPtrFor returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='for' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getNoPtrForAccess().getForKeyword_0());
    }
	otherlv_1='(' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getNoPtrForAccess().getLeftParenthesisKeyword_1());
    }
(this_ID_2=RULE_ID
    { 
    newLeafNode(this_ID_2, grammarAccess.getNoPtrForAccess().getIDTerminalRuleCall_2_0()); 
    }
this_ID_3=RULE_ID
    { 
    newLeafNode(this_ID_3, grammarAccess.getNoPtrForAccess().getIDTerminalRuleCall_2_1()); 
    }
(	otherlv_4='=' 
    {
    	newLeafNode(otherlv_4, grammarAccess.getNoPtrForAccess().getEqualsSignKeyword_2_2_0());
    }
(this_ID_5=RULE_ID
    { 
    newLeafNode(this_ID_5, grammarAccess.getNoPtrForAccess().getIDTerminalRuleCall_2_2_1_0()); 
    }

    |this_INT_6=RULE_INT
    { 
    newLeafNode(this_INT_6, grammarAccess.getNoPtrForAccess().getINTTerminalRuleCall_2_2_1_1()); 
    }
))?)?	otherlv_7=';' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getNoPtrForAccess().getSemicolonKeyword_3());
    }
(this_ID_8=RULE_ID
    { 
    newLeafNode(this_ID_8, grammarAccess.getNoPtrForAccess().getIDTerminalRuleCall_4_0()); 
    }
((	otherlv_9='<' 
    {
    	newLeafNode(otherlv_9, grammarAccess.getNoPtrForAccess().getLessThanSignKeyword_4_1_0_0());
    }

    |	otherlv_10='>' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getNoPtrForAccess().getGreaterThanSignKeyword_4_1_0_1());
    }

    |	otherlv_11='==' 
    {
    	newLeafNode(otherlv_11, grammarAccess.getNoPtrForAccess().getEqualsSignEqualsSignKeyword_4_1_0_2());
    }

    |	otherlv_12='!=' 
    {
    	newLeafNode(otherlv_12, grammarAccess.getNoPtrForAccess().getExclamationMarkEqualsSignKeyword_4_1_0_3());
    }

    |	otherlv_13='&&' 
    {
    	newLeafNode(otherlv_13, grammarAccess.getNoPtrForAccess().getAmpersandAmpersandKeyword_4_1_0_4());
    }

    |	otherlv_14='|' 
    {
    	newLeafNode(otherlv_14, grammarAccess.getNoPtrForAccess().getVerticalLineKeyword_4_1_0_5());
    }
)this_ID_15=RULE_ID
    { 
    newLeafNode(this_ID_15, grammarAccess.getNoPtrForAccess().getIDTerminalRuleCall_4_1_1()); 
    }
)?)?	otherlv_16=';' 
    {
    	newLeafNode(otherlv_16, grammarAccess.getNoPtrForAccess().getSemicolonKeyword_5());
    }
(this_ID_17=RULE_ID
    { 
    newLeafNode(this_ID_17, grammarAccess.getNoPtrForAccess().getIDTerminalRuleCall_6_0()); 
    }
	otherlv_18='+=' 
    {
    	newLeafNode(otherlv_18, grammarAccess.getNoPtrForAccess().getPlusSignEqualsSignKeyword_6_1());
    }
this_INT_19=RULE_INT
    { 
    newLeafNode(this_INT_19, grammarAccess.getNoPtrForAccess().getINTTerminalRuleCall_6_2()); 
    }
)?	otherlv_20=')' 
    {
    	newLeafNode(otherlv_20, grammarAccess.getNoPtrForAccess().getRightParenthesisKeyword_7());
    }
	otherlv_21='{' 
    {
    	newLeafNode(otherlv_21, grammarAccess.getNoPtrForAccess().getLeftCurlyBracketKeyword_8());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrForAccess().getEscopoNoPtrStatementParserRuleCall_9_0()); 
	    }
		lv_escopo_22_0=ruleNoPtrStatement		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrForRule());
	        }
       		set(
       			$current, 
       			"escopo",
    ...
    {
    	newLeafNode(otherlv_23, grammarAccess.getNoPtrForAccess().getRightCurlyBracketKeyword_10());
    }
)
;
...
entryRuleNoPtrWhile returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrWhileRule()); }
	 iv_ruleNoPtrWhile=ruleNoPtrWhile 
	 { $current=$iv_ruleNoPtrWhile.current; } 
	 EOF 
;

// Rule NoPtrWhile
ruleNoPtrWhile returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='while' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getNoPtrWhileAccess().getWhileKeyword_0());
    }
	otherlv_1='(' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getNoPtrWhileAccess().getLeftParenthesisKeyword_1());
    }
(this_ID_2=RULE_ID
    { 
    newLeafNode(this_ID_2, grammarAccess.getNoPtrWhileAccess().getIDTerminalRuleCall_2_0()); 
    }
((	otherlv_3='<' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getNoPtrWhileAccess().getLessThanSignKeyword_2_1_0_0());
    }

    |	otherlv_4='>' 
    {
    	newLeafNode(otherlv_4, grammarAccess.getNoPtrWhileAccess().getGreaterThanSignKeyword_2_1_0_1());
    }

    |	otherlv_5='==' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getNoPtrWhileAccess().getEqualsSignEqualsSignKeyword_2_1_0_2());
    }

    |	otherlv_6='!=' 
    {
    	newLeafNode(otherlv_6, grammarAccess.getNoPtrWhileAccess().getExclamationMarkEqualsSignKeyword_2_1_0_3());
    }

    |	otherlv_7='&&' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getNoPtrWhileAccess().getAmpersandAmpersandKeyword_2_1_0_4());
    }

    |	otherlv_8='|' 
    {
    	newLeafNode(otherlv_8, grammarAccess.getNoPtrWhileAccess().getVerticalLineKeyword_2_1_0_5());
    }
)this_ID_9=RULE_ID
    { 
    newLeafNode(this_ID_9, grammarAccess.getNoPtrWhileAccess().getIDTerminalRuleCall_2_1_1()); 
    }
)?)?	otherlv_10=')' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getNoPtrWhileAccess().getRightParenthesisKeyword_3());
    }
	otherlv_11='{' 
    {
    	newLeafNode(otherlv_11, grammarAccess.getNoPtrWhileAccess().getLeftCurlyBracketKeyword_4());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrWhileAccess().getEscopoNoPtrStatementParserRuleCall_5_0()); 
	    }
		lv_escopo_12_0=ruleNoPtrStatement		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrWhileRule());
	        }
       		set(
       			$current, 
       			"escopo",
    ...
    {
    	newLeafNode(otherlv_13, grammarAccess.getNoPtrWhileAccess().getRightCurlyBracketKeyword_6());
    }
)
;
...
entryRuleNoPtrMudanca returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrMudancaRule()); }
	 iv_ruleNoPtrMudanca=ruleNoPtrMudanca 
	 { $current=$iv_ruleNoPtrMudanca.current; } 
	 EOF 
;

// Rule NoPtrMudanca
ruleNoPtrMudanca returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getNoPtrMudancaAccess().getNoPtrMudancaAction_0(),
            $current);
    }
)(
(
		lv_name_1_0=RULE_ID
		{
			newLeafNode(lv_name_1_0, grammarAccess.getNoPtrMudancaAccess().getNameIDTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getNoPtrMudancaRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getNoPtrMudancaAccess().getEqualsSignKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrMudancaAccess().getExprNoPtrExpressionParserRuleCall_2_1_0()); 
	    }
		lv_expr_3_0=ruleNoPtrExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrMudancaRule());
	        }
       		set(
       			$current, 
       			"expr",
...
entryRuleNoPtrExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrExpressionRule()); }
	 iv_ruleNoPtrExpression=ruleNoPtrExpression 
	 { $current=$iv_ruleNoPtrExpression.current; } 
	 EOF 
;

// Rule NoPtrExpression
ruleNoPtrExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getNoPtrExpressionAccess().getNoPtrExpressionAction_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrExpressionAccess().getLeftNoPtrTerminalExpressionParserRuleCall_1_0()); 
	    }
		lv_left_1_0=ruleNoPtrTerminalExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrExpressionRule());
	        }
       		set(
       			$current, 
       			"left",
...
(
		lv_op_2_1=	'&&' 
    {
        newLeafNode(lv_op_2_1, grammarAccess.getNoPtrExpressionAccess().getOpAmpersandAmpersandKeyword_2_0_0_0());
    }
 
	    {
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getNoPtrExpressionRule());
	        }
    ...
    |		lv_op_2_2=	'||' 
    {
        newLeafNode(lv_op_2_2, grammarAccess.getNoPtrExpressionAccess().getOpVerticalLineVerticalLineKeyword_2_0_0_1());
    }
    ...
    |		lv_op_2_3=	'==' 
    {
        newLeafNode(lv_op_2_3, grammarAccess.getNoPtrExpressionAccess().getOpEqualsSignEqualsSignKeyword_2_0_0_2());
    }
    ...
    |		lv_op_2_4=	'!=' 
    {
        newLeafNode(lv_op_2_4, grammarAccess.getNoPtrExpressionAccess().getOpExclamationMarkEqualsSignKeyword_2_0_0_3());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrExpressionAccess().getRightNoPtrTerminalExpressionParserRuleCall_2_1_0()); 
	    }
		lv_right_3_0=ruleNoPtrTerminalExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrExpressionRule());
	        }
       		set(
...
entryRuleNoPtrTerminalExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrTerminalExpressionRule()); }
	 iv_ruleNoPtrTerminalExpression=ruleNoPtrTerminalExpression 
	 { $current=$iv_ruleNoPtrTerminalExpression.current; } 
	 EOF 
;

// Rule NoPtrTerminalExpression
ruleNoPtrTerminalExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getNoPtrTerminalExpressionAccess().getNoPtrTerminalExpressionAction_0_0(),
            $current);
    }
)(	otherlv_1='!' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getNoPtrTerminalExpressionAccess().getExclamationMarkKeyword_0_1());
    }
)*	otherlv_2='(' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getNoPtrTerminalExpressionAccess().getLeftParenthesisKeyword_0_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrTerminalExpressionAccess().getInsideNoPtrExpressionParserRuleCall_0_3_0()); 
	    }
		lv_inside_3_0=ruleNoPtrExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrTerminalExpressionRule());
	        }
       		set(
       			$current, 
       			"inside",
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getNoPtrTerminalExpressionAccess().getRightParenthesisKeyword_0_4());
    }
)
    |((
	{ 
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getNoPtrTerminalExpressionAccess().getAtomicAction_1_0(),
            $current);
    }
)(	otherlv_6='!' 
    {
    	newLeafNode(otherlv_6, grammarAccess.getNoPtrTerminalExpressionAccess().getExclamationMarkKeyword_1_1());
    }
)*(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrTerminalExpressionAccess().getAtomicReturnExprParserRuleCall_1_2_0()); 
	    }
		lv_atomic_7_0=ruleReturnExpr		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrTerminalExpressionRule());
	        }
       		set(
...
entryRuleNoPtrSelect returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrSelectRule()); }
	 iv_ruleNoPtrSelect=ruleNoPtrSelect 
	 { $current=$iv_ruleNoPtrSelect.current; } 
	 EOF 
;

// Rule NoPtrSelect
ruleNoPtrSelect returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrSelectAccess().getExprNoPtrExpressionParserRuleCall_3_0()); 
	    }
		lv_expr_3_0=ruleNoPtrExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrSelectRule());
	        }
       		set(
       			$current, 
       			"expr",
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getNoPtrSelectAccess().getRightParenthesisKeyword_4());
    }
	otherlv_5='{' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getNoPtrSelectAccess().getLeftCurlyBracketKeyword_5());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrSelectAccess().getCasesNoPtrCasesParserRuleCall_6_0()); 
	    }
		lv_cases_6_0=ruleNoPtrCases		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrSelectRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getNoPtrSelectAccess().getRightCurlyBracketKeyword_7());
    }
)
;
...
entryRuleNoPtrCases returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNoPtrCasesRule()); }
	 iv_ruleNoPtrCases=ruleNoPtrCases 
	 { $current=$iv_ruleNoPtrCases.current; } 
	 EOF 
;

// Rule NoPtrCases
ruleNoPtrCases returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getNoPtrCasesAccess().getDefaultCaseAction_0_0(),
            $current);
    }
)	otherlv_1='default' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getNoPtrCasesAccess().getDefaultKeyword_0_1());
    }
	otherlv_2=':' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getNoPtrCasesAccess().getColonKeyword_0_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrCasesAccess().getVNoPtrStatementParserRuleCall_0_3_0()); 
	    }
		lv_v_3_0=ruleNoPtrStatement		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrCasesRule());
	        }
       		set(
       			$current, 
       			"v",
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getNoPtrCasesAccess().getCaseNormalAction_1_0(),
            $current);
    }
)	otherlv_5='case' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getNoPtrCasesAccess().getCaseKeyword_1_1());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrCasesAccess().getExprNoPtrExpressionParserRuleCall_1_2_0()); 
	    }
		lv_expr_6_0=ruleNoPtrExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrCasesRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getNoPtrCasesAccess().getColonKeyword_1_3());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getNoPtrCasesAccess().getVNoPtrStatementParserRuleCall_1_4_0()); 
	    }
		lv_v_8_0=ruleNoPtrStatement		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getNoPtrCasesRule());
	        }
       		set(
...
(	otherlv_10='!' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getParameterAccess().getExclamationMarkKeyword_6_1());
    }
)*(
(
		{ 
...
(	otherlv_10='!' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getVarDeclAccess().getExclamationMarkKeyword_6_1());
    }
)*(
(
		{ 
...
(
		{ 
	        newCompositeNode(grammarAccess.getReturnAccess().getRettypeNoPtrExpressionParserRuleCall_2_0()); 
	    }
		lv_rettype_2_0=ruleNoPtrExpression		{
	        if ($current==null) {
...
(
		...
		{
			newLeafNode(lv_value_1_0, grammarAccess.getReturnExprAccess().getValueINTTerminalRuleCall_0_1_0()); 
		}
		{
	        if ($current==null) {
...
(
		...
		{
			newLeafNode(lv_value_5_0, grammarAccess.getReturnExprAccess().getValueSTRINGTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getReturnExprRule());
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getReturnExprAccess().getFunctionTypeAction_3_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getReturnExprAccess().getCallFunctionChamadaParserRuleCall_3_1_0()); 
	    }
		lv_call_7_0=ruleFunctionChamada		{
	        if ($current==null) {
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getReturnExprAccess().getVariableAction_4_0(),
            $current);
    }
)(
(
		lv_name_9_0=RULE_ID
		{
			newLeafNode(lv_name_9_0, grammarAccess.getReturnExprAccess().getNameIDTerminalRuleCall_4_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getReturnExprRule());
...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSelectionStatementAccess().getIfKeyword_0()); 
    }

	kw='(' 
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSelectionStatementAccess().getLeftParenthesisKeyword_1()); 
    }

    { 
        newCompositeNode(grammarAccess.getSelectionStatementAccess().getConditionParserRuleCall_2()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSelectionStatementAccess().getRightParenthesisKeyword_3()); 
    }

    { 
        newCompositeNode(grammarAccess.getSelectionStatementAccess().getStatementParserRuleCall_4()); 
    }
...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSelectionStatementAccess().getElseKeyword_5_0()); 
    }

    { 
        newCompositeNode(grammarAccess.getSelectionStatementAccess().getStatementParserRuleCall_5_1()); 
    }
    this_Statement_6=ruleStatement    {
		$current.merge(this_Statement_6);
    }
...
ruleIterationStatement returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
	...
	kw='asjkajksjksajskjskjskjskjaskajsksjkasjksajsakjsksjaksajksajksj' 
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getIterationStatementAccess().getAsjkajksjksajskjskjskjskjaskajsksjkasjksajsakjsksjaksajksajksjKeyword()); 
    }
...
(
    ...
    { 
    newLeafNode(this_STRING_4, grammarAccess.getStaticAssertDeclarationAccess().getSTRINGTerminalRuleCall_4()); 
    }
...
(
    ...
    { 
    newLeafNode(this_STRING_2, grammarAccess.getAsmDefinitionAccess().getSTRINGTerminalRuleCall_2()); 
    }
...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getPlusSignPlusSignKeyword_30()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getHyphenMinusHyphenMinusKeyword_31()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getCommaKeyword_32()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getHyphenMinusGreaterThanSignAsteriskKeyword_33()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getHyphenMinusGreaterThanSignKeyword_34()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getLeftParenthesisRightParenthesisKeyword_35()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOverloadableOperatorAccess().getLeftSquareBracketRightSquareBracketKeyword_36()); 
    }
)
    ;
